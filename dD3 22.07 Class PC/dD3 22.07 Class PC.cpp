...
*/
//3) Добавить к коду на слайде 24 презентации по Паттернам проектирования 
// (выслана в Тимс) возможность создавать игровые компьютеры.
...
class GamersPc :public PC{
    ...
    void SetMemory()override
    {
        memory = "Many Gamer'sDDR6 100500GB RAM";
    }
...
class CreatorGamersPC : public Creator
{
public:
    PC* FactoryMethod()override
    {
...
void main()
{
    ...
    creators[2] = new CreatorGamersPC();
    Factory(creators, 3);
}
